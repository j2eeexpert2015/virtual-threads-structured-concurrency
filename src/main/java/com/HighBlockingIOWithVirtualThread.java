...
/**
 * Simulates a high-blocking workload using virtual threads.
 * - Uses sleep to simulate blocking I/O (safe: causes unmount).
 * - Can scale to thousands of concurrent tasks with low overhead.
 */
public class HighBlockingIOWithVirtualThread {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("\n[Virtual Threads] Total execution time: " + (end - start) + " ms");
    }
